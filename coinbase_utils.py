...
def user_choose_confirm(client, currency="BTC", desc="account"):
    ...
    while not sel_account:
        ...
        if not accounts:
            continue
        if len(accounts) == 1:
            print("One {} {} found:".format(currency, desc))
            ...
            print(colored("If this is not the account you want to use,\n"
                          ...
                          "on https://coinbase.com\n".format(currency), "cyan"))
            ...
            for account_index, account in accounts_hash.items():
                print("{} - ".format(account_index) +
                      colored("{} {}\n".format(
                                  account.balance.amount,
                                  account.balance.currency),
                              "blue"))

            print("{} - None of the above\n".format(len(accounts_hash)) +
    ...
    while not sel_method:
        ...
        if len(methods) == 1:
            ...
            for method_index, method in methods_hash.items():
                print("{} - ".format(method_index) + colored("{}\n".format(method.name), "blue"))
